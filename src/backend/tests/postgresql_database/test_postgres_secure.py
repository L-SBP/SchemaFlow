...
from src.backend.app.postgresql.postgres_secure import normalize_sql, match_operation, validate_safe_sql
from src.backend.app.core.exceptions import SQLSecurityException


class TestPostgresSecure:
    """Test cases for postgres_secure.py"""
    ...
    @patch('app.postgresql.postgres_secure.config')
