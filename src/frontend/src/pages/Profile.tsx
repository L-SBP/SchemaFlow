            ...
            {activeTab === 'security' && (
              <div className="space-y-4 animate-in fade-in slide-in-from-right-2 duration-200">
                ...
                <div className="pt-4 flex justify-end">
                  <Button variant="primary" icon={<Save size={16} />}>更新密码</Button>
                </div>
              </div>
            )}
              ...
              <div className="space-y-4 animate-in fade-in slide-in-from-right-2 duration-200">
                {step === 1 ? (
                  <>
                    ...
                    />
                     <div className="pt-4 flex justify-end">
                      <Button variant="primary" onClick={() => setStep(2)}>发送验证码</Button>
                    </div>
                  </>
                ) : (
                  <>
                    ...
                    <div className="pt-4 flex justify-end gap-2">
                      ...
                      <Button variant="primary" icon={<Save size={16} />}>确认绑定</Button>
                    </div>
                  </>
                )}
              </div>
